...
_G.luasnip.vars = {
  username = 'noahares',
  email = 'noah.ares@yahoo.de',
  github = 'https://github.com/noahares',
  real_name = 'Noah Wahl',
}
...
local marks = {
  date_signature = function()
    return fmt('<{}{}>', { i(1, os.date(dateformat)), i(2, ', ' .. _G.luasnip.vars.username) })
  end,
  date = function()
    return fmt('<{}>', i(1, os.date(dateformat)))
  end,
  signature = function()
  ...
  date_signature_with_email = function()
    return fmt(
      '<{}{}{}>',
      { i(1, os.date(dateformat)), i(2, ', ' .. _G.luasnip.vars.username), i(3, ' ' .. _G.luasnip.vars.email) }
    )
  end,
